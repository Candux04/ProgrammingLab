...
class CSVTimeSeriesFile:
    ...
    def get_data(self):
        ...
        #Il file CSV può contenere letteralmente di tutto. Da linee incomplete a pezzi di testo che non c’entrano niente, e ogni errore va ignorato (ovvero, ignoro la riga contenente l’errore e vado a quella dopo). 
        listlist=[]
...
#da vedere per anni vuoti consecutivi/più di uno
    amp=m
    lista_scarti=[]
    lista_anni=[]
    t=1
